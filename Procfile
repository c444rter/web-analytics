...
worker: cd backend && rq worker --with-scheduler --url ${REDIS_URL} --name worker-${RAILWAY_SERVICE_ID:-local} --verbose --worker-ttl 3600 --results-ttl 3600 --max-jobs 0 default
